...
function dl_enqueue_scripts() {
	...
	/* Register Scripts propios */
	wp_register_script( 'jquery', get_theme_file_uri('/assets/js/jquery-3.3.1.min.js'), array('jquery-migrate'), '3.3.1', true );
